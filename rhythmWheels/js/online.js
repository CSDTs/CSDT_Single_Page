...
function updateProjectDetails(data, state) {
	...
	loadProjectPreview.setAttribute("src", `${isAppHomepage ? currentLocation : ""}img/project_default.png`);
...
function saveProjectToCloud() {
	...
	let projectForm = generateRhythmSaveFormData(saveObject.project, "application/json");
