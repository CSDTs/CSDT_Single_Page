...
$("#interactive-verification").on("click", () => {
  if ($(userInteractions.usernameField).val() !== "") {
    workbook.verified = true;
    workbook.responses[0] = 'verified'
    console.log(workbook.responses);
  ...
  $(userInteractions.validateField).attr(
    "placeholder",
    $(userInteractions.usernameField).val()
  );
});
